...
#trbcmd w 0x8000 0x8106 0xc0a80115   # source IP trb021
#trbcmd w 0x8000 0x8106 0xc0a80123   # source IP trb035
trbcmd w 0x8000 0x8106 0xc0a80159   # source IP trb089
...
# 										  #
# trbcmd w 0x8001 0x8102 0xc0a80002   # destination IP-address: 192.168.0.2	  #
...
# trbcmd w 0x8001 0x8106 0xc0a80115   # source IP trb021			  #
# #trbcmd w 0x8001 0x8106 0xc0a80123   # source IP trb035			  #
