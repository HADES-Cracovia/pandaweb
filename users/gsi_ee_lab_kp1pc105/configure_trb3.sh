...
trbcmd w 0x8000 0x8304 0x578        # max frame size
...
trbcmd w 0x8000 0x8104 0xdead0110   # source MAC-address: 192.168.1.16
trbcmd w 0x8000 0x8105 0x001b       # source MAC: upper bytes
trbcmd w 0x8000 0x8106 0xc0a80172   # source IP
